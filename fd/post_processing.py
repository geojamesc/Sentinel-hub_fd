...
class TemporalMerging(EOTask):
    def __init__(self, feature: Tuple[FeatureType, str], feature_merged: Tuple[FeatureType, str],
                 woy_start: int, woy_end: int, percentile: int = 50,
        ...
        self.woy_start = woy_start
        self.woy_end = woy_end
    ...
    def execute(self, eopatch: EOPatch) -> EOPatch:
        ...
        eopatch[self.feature_merged] = np.nanpercentile(features, q=self.percentile, axis=0)
